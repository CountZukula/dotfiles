...
# load colors in variables for easy access
# gruvbox colors...
...
darkgrey = xresources['*color8']
background = xresources['*background']
backgroundsoft = xresources['*backgroundsoft']
backgroundhard = xresources['*backgroundhard']
foreground = xresources['*foreground']

# overrule scroll behaviour
config.bind('j', 'scroll-page 0 0.1')
config.bind('k', 'scroll-page 0 -0.1')

# This fixes leaving insert mode whenever google maps does ajax stuff... 
...
## Type: QssColor
c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 darkgrey, stop:1 black)'
...
## Type: QtColor
c.colors.tabs.indicator.stop = darkgreen
